...
export function getTransactionsInfoByIdRequestSuccessAction(
...
export function resetTransactionInfoByIdAction() {
  return {
    type: RESET_TRANSACTION_INFO_BY_ID,
    // payload: error,
  };
}
...
export function getMyTransactionsRequestSuccessAction(
  data: ITransactionInfo[] | []
) {
  return {
